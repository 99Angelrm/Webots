...
## ¿Qué variables cambia del controlador plantilla?

El script de python cambia las cadenas de caracteres _{nombre}_ con el nombre del controlador que lo obtiene de la ruta ingresada.
